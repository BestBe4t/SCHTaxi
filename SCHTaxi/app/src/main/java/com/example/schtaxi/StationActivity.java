    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(StationActivity.this, CreateActivity.class);
        ...
        Search_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(StationActivity.this, StationActivity.class);
        ...
        index1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                user.set_IDX(1);
                Intent intent1 = new Intent(StationActivity.this, IndexActivity.class);
                intent1.putExtra("Name", user.getName());
                intent1.putExtra("PH", user.getPH());
